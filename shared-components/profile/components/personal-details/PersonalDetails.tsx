                            ...
                            {/** Display profile picture */}
                            {
                                getProfilePicture(copiedUser) === null
                                    ...
                                    : <Image
                                        roundedCircle
                                        thumbnail
                                        src={getProfilePicture(copiedUser) ?? ""}
                                        width={256}
                                        height={256}
                                        style={{
                                            objectFit: "contain"
                                ...
                                currentAdmin
                                    ...
                                    >
                                        <Button
                                            ...
                                            variant="outlined"
                                            color="primary"
                                            onClick={() => toggleUpdateProfilePhotoDialog(getProfilePicture(copiedUser) ?? undefined)}
                                        >
                        ...
                        >
                            ...
                            >
                                ...
                                <TextField
                                    ...
                                    value={copiedUser.lastName}
                                    margin="dense"
                                    variant="outlined"
                                    onChange={this.onInputFieldChanged(InputCategories.PersonalDetails)}
                                    error={copiedUser.lastName.trim().length === 0}
                                />
                            </FormControl>
                            ...
                            >
                                ...
                                <TextField
                                    ...
                                    onChange={this.onInputFieldChanged(InputCategories.PersonalDetails)}
                                    disabled={true}
                                    error={copiedUser.email.trim().length === 0}
                                />
                            </FormControl>
                            ...
                            >
                                ...
                                <TextField
                                    ...
                                    value={copiedUser.linkedin ?? ""}
                                    margin="dense"
                                    variant="outlined"
                                    onChange={this.onInputFieldChanged(InputCategories.PersonalDetails)}
                                    error={!utils.isValidLinkedInURL(copiedUser.linkedin)}
                                />
                            </FormControl>
                        </Box>
                    </Col>
