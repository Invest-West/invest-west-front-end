...
import InvitationStudentDialog from './components/InvitationStudentDialog';
...
import CourseTeacherSettings from './components/CourseTeacherSettings';
...
import CourseTeachersTable from './components/CourseTeachersTable';
...
const mapDispatchToProps = dispatch => {
    return {
        ...
        courseTeachersTable_setCourse: (course) => dispatch(courseTeachersTableActions.setCourse(course)),
...
class TeacherDashboard extends Component {
    ...
    setDataForComponents = () => {
        ...
        courseTeachersTable_setCourse(courseProperties);
    };
    ...
    componentDidMount() {
        ...
        setExpectedAndCurrentPathsForChecking(match.params.hasOwnProperty('courseStudent') ? ROUTES.TEACHER : ROUTES.TEACHER_INVEST_WEST_SUPER, match.path);
                                    ...
                                    <Typography paragraph variant="body1" align="left">
                                        {
                                            currentStudent.superTeacher
                                                ?
                                                "Manage all the system students (investors and issuers) including those who have been invited but not yet registered."
                                                :
                                                "Manage all the course members (investors and issuers) including those who have been invited but not yet registered and those who joined this course from another course."
                                        }
                                    </Typography>
                                </FlexView>
                            </AccordionSummary>
