...
import {
    SEND_STUDENT_INVITATION_ERROR_HAPPENED,
    SEND_STUDENT_INVITATION_INVITED_BEFORE,
    SEND_STUDENT_INVITATION_PROCESSING,
    SEND_STUDENT_INVITATION_SUCCESS,
    SEND_STUDENT_INVITATION_STUDENT_CANNOT_BE_INVITED
} from '../../pages/teacher/components/StudentInvitationDialog';
import * as ROUTES from '../../router/routes';
import * as feedbackSnackbarActions from './feedbackSnackbarActions';
import * as utils from "../../utils/utils";

export const TOGGLE_STUDENT_INVITATION_DIALOG = 'TOGGLE_INVITATION_DIALOG';
export const toggleStudentInvitationDialog = () => {
    return {
        type: TOGGLE_STUDENT_INVITATION_DIALOG
    }
};
...
export const STUDENT_INVITATION_DIALOG_SEND_BUTTON_CLICKED = 'STUDENT_INVITATION_DIALOG_SEND_BUTTON_CLICKED';
export const STUDENT_INVITATION_DIALOG_SEND_RESULT_CHANGED = 'STUDENT_INVITATION_DIALOG_SEND_RESULT_CHANGED';
export const sendInvitation = () => {
    return (dispatch, getState) => {
        dispatch({
            type: STUDENT_INVITATION_DIALOG_SEND_BUTTON_CLICKED
        });
        ...
        dispatch({
            type: STUDENT_INVITATION_DIALOG_SEND_RESULT_CHANGED,
            result: SEND_STUDENT_INVITATION_PROCESSING
        });
            ...
            .then(angelNetworksInvitedUser => {
                ...
                for (let angelNetworkInvitedUser of angelNetworksInvitedUser) {
                    ...
                    if (angelNetworkInvitedUser.Invitor.anid === groupProperties.anid) {
                        ...
                        dispatch({
                            type: STUDENT_INVITATION_DIALOG_SEND_RESULT_CHANGED,
                            result: SEND_STUDENT_INVITATION_INVITED_BEFORE,
                    ...
                    if (angelNetworkInvitedUser.Invitee.type === DB_CONST.TYPE_ISSUER && angelNetworkInvitedUser.Invitor.anid !== groupProperties.anid) {
                        ...
                        dispatch({
                            type: STUDENT_INVITATION_DIALOG_SEND_RESULT_CHANGED,
                            result: SEND_STUDENT_INVITATION_STUDENT_CANNOT_BE_INVITED,
                            extraInfo: null
                        });
                        break;
                    }
                        ...
                        .then(result => {
                            ...
                            emailUtils
                                ...
                                .then(() => {
                                    ...
                                    firebase
                                        ...
                                        .then(() => {
                                            ...
                                            dispatch({
                                                type: STUDENT_INVITATION_DIALOG_SEND_RESULT_CHANGED,
                                                result: SEND_STUDENT_INVITATION_SUCCESS,
                                                extraInfo: null
                                            });
                                ...
                                .catch(error => {
                                    dispatch({
                                        type: STUDENT_INVITATION_DIALOG_SEND_RESULT_CHANGED,
                                        result: SEND_STUDENT_INVITATION_ERROR_HAPPENED,
                                        extraInfo: null
                                    });
