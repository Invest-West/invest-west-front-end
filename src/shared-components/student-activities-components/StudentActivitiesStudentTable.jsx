...
const mapStateToProps = state => {
    return {
        groupStudentName: state.manageGroupFromParams.groupStudentName,
        ...
        currentStudent: state.auth.user,

        tableStudent: state.manageActivitiesTable.tableStudent,
...
class ActivitiesTable extends Component {
    ...
    render() {
        ...
        if (!groupPropertiesLoaded || !tableStudent || !currentStudent) {
            return null;
        }
                                        ...
                                        <Typography variant="body2" align="left" >
                                            <NavLink
                                                to={
                                                    groupStudentName
                                                        ?
                                                        `${ROUTES.GROUP_PATH.replace(":groupStudentName", groupStudentName)}${activity.action}`
                                                        :
                                                        activity.action
                                                }
