...
import {
    ...
    setEditor,
    toggleDialog
} from "./StudentEditImageDialogActions";
...
class EditStudentImageDialog extends Component<EditImageDialogProps, any> {
    ...
    render() {
        ...
        const EditImageLocalState: EditImageDialogState = StudentProfileLocalState.EditImageDialogState;
...
export default connect(mapStateToProps, mapDispatchToProps)(EditStudentImageDialog);
